...
class OsteoporosisInferencer:
    ...
    def __init__(self, weight_path, device=None):
        ...
        self.transform = T.Compose([T.Resize((256, 512)), T.ToTensor()])
    ...
    def predict(self, image_path_or_pil):
        ...
        with torch.no_grad():
            ...
            if pred_pixel is not None:
                ...
                mask = (recon_img * 255).astype(
                    np.uint8
                )  # Return as pseudo-mask/visualization
            else:
        ...
        geom_feats = {
            "message": "Morphology analysis disabled in Autoencoder (Mask-Free) mode."
        }
